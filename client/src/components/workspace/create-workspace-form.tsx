    ...
    <main className="w-full flex flex-row min-h-[590px] h-auto max-w-full">
      <div className="h-full px-10 py-10 flex-1">
        <div className="mb-5">
          ...
          >
            Let's create your SyncHub Workspace
          </h1>
          <p className="text-muted-foreground text-lg leading-tight">
            Sync your team's work and boost productivity with centralized
            project management.
          </p>
        </div>
        <Form {...form}>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        rows={6}
                        placeholder="Our team syncs projects, tasks, and collaboration here."
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                      Get your team on board with a few words about your SyncHub
                      workspace.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
