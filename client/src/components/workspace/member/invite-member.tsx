  ...
  return (
    <div className="flex flex-col pt-0.5 px-0 ">
      <h5 className="text-lg  leading-[30px] font-semibold mb-1">
        Invite team members to sync with you
      </h5>
      <p className="text-sm text-muted-foreground leading-tight">
        Anyone with an invite link can join your SyncHub workspace. You can also
        disable and create a new invite link at any time.
      </p>
