...
export const removeWorkspaceMemberMutationFn = async ({
  ...
  const response = await API.delete(
    `/workspace/remove/member/${workspaceId}`,
    { data: { memberId } }
  );
  return response.data;
};
...
export const getProjectsInWorkspaceQueryFn = async ({
  ...
  const response = await API.get(
    `/project/workspace/${workspaceId}/getAll?pageSize=${pageSize}&pageNumber=${pageNumber}`
  );
  return response.data;
};
...
export const createTaskMutationFn = async ({
  ...
  const response = await API.post(
    `/task/${projectId}/workspace/${workspaceId}/create`,
    data
  );
  return response.data;
};
